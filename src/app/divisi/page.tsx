...
const divisionsData: Division[] = [
  ...
  {
    id: "kreatif",
    name: "Divisi Kreatif & Media",
    description: "Mengembangkan konten kreatif dan mengelola media sosial organisasi",
    ...
    members: [
      ...
      },
      {
        ...
        role: "member",
        email: "lina.permata@email.com",
        phone: "+62 819-0123-4567",
        department: "Videografi",
