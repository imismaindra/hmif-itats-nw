...
const divisionsData: Division[] = [
  {
    ...
    members: [
      ...
      {
        id: "6",
        name: "Danu Dwi Saputra",
        role: "member",
        email: "exemple@exemple.com",
        phone: "+62 831-1211-6135",
        department: "Anggota",
        avatar: "/professional-female-student.jpg",
      },
      {
        id: "7",
        name: "Achmad Rizqi Mubarok",
        role: "member",
        email: "exemple@exemple.com",
        phone: "+62 ",
        department: "Anggota",
      ...
      {
        id: "8",
        name: "Aryo Syarif Kamal Akbar",
        role: "member",
        email: "exemple@exemple.com",
        phone: "+62 878-1869-0516",
        department: "Anggota",
        avatar: "/professional-female-student.jpg",
      },
      {
        id: "9",
        name: "Gansa Alega Putra Utomo",
        role: "member",
        email: "exemple@exemple.com",
        phone: "+62 881-6942-260",
        department: "Anggota",
        avatar: "/professional-female-student.jpg",
      },
    ],
  ...
  {
    id: "humas",
    name: "Divisi Media Digital & Hubungan Masyarakat",
    ...
    members: [
      ...
      {
        id: "14",
        name: "M. Farhan Magribi",
        role: "member",
        email: "exemple@exemple.com",
        phone: "+62 858-5013-1912",
        department: "Public Relations",
        avatar: "/professional-male-student-confident.jpg",
      },
      {
        id: "15",
        name: "Abdiel Rozi Syahputra",
        role: "member",
        email: "exemple@exemple.com",
        phone: "+62 896-8722-5121",
        department: "Public Relations",
        avatar: "/professional-male-student-confident.jpg",
      },
      {
  ...
  },
  {
    ...
    members: [
      ...
      },
      {
        ...
        role: "member",
        email: "exemple@exemple.com",
        phone: "+62 895-3185-3860",
        department: "Litbang",
        avatar: "/creative-female-student-camera.jpg",
      },
      {
        id: "23",
        name: "Moch. Syahril Akbar",
        role: "member",
        email: "exemple@exemple.com",
        phone: "+62 ",
        department: "Litbang",
      ...
      {
        id: "23",
        name: "Achmad Ali Fattahillah",
        role: "member",
        email: "exemple@exemple.com",
        phone: "+62 831-3681-6158",
        department: "Litbang",
        avatar: "/creative-female-student-camera.jpg",
      },
    ],
